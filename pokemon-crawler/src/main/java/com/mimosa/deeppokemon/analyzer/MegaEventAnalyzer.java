...
@Component
public class MegaEventAnalyzer implements BattleEventAnalyzer {
    private static final Logger log = LoggerFactory.getLogger(MegaEventAnalyzer.class);
    protected static final String MEGA = "mega";
    private static final Set<String> SUPPORT_EVENT_TYPE = Set.of(MEGA);
    protected static final int TARGET_INDEX = 0;
    protected static final int ITEM_INDEX = 2;
