...
public class TeamApiController {
    ...
    public TeamGroupDto team(@PathVariable("teamId") String teamId,
                             ...
                             @RequestParam(required = false, name = "searchPrivate", defaultValue = "false") boolean searchPrivate) {
        return battleService.searchTeam(new Binary(Base64.getDecoder().decode(teamId)), replayNum, format, searchPrivate);
    }
}